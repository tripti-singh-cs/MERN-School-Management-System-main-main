...
import {
    Box, Container, Typography, Tab, IconButton, Stack
} from '@mui/material';
...
const ClassDetails = () => {
    ...
    const ClassTeachersSection = () => <Typography variant="h5">Teachers</Typography>;
    ...
    const ClassDetailsSection = () => {
        ...
        return (
            <Stack spacing={2} alignItems="center">
                ...
                <Typography variant="h5">This is Class {sclassDetails?.sclassName}</Typography>
                <Typography variant="h6">Number of Subjects: {numberOfSubjects}</Typography>
                <Typography variant="h6">Number of Students: {numberOfStudents}</Typography>
        ...
        <>
            <Box sx={{ width: '100%', typography: 'body1' }}>
                <TabContext value={value}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider', position: 'fixed', width: '100%', bgcolor: 'background.paper', zIndex: 1 }}>
